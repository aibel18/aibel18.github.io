    ...
    <!--Section: about-->
      <section id="about" class="text-center py-5">
        ...
        <div class="container">
          ...
          <!--Content-->
          <p style="width: 95%;margin: auto;max-width:850px;text-align: justify;">
      ...
      <!--Section: skills-->
      <section class="text-center py-5" style="background-color: rgba(238, 238, 238, 0.3);">
            ...
            <div class="col-lg-7">
              <div style="position:relative;">
                ...
                <div style="margin-left: 28px;text-align: left">
                  ...
                  <h6>2009-2015</h6>              
                  <h6>student at the <a href="http://fips.unsa.edu.pe/ingenieriadesistemas/"> EPIS</a></h6>
                  <p >Arequipa - Peru</p>
                </div>
              </div>
